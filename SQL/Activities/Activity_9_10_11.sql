...
SELECT * FROM orders 
WHERE salesman_id=(SELECT DISTINCT salesman_id FROM orders WHERE customer_id=5007);
...
SELECT * FROM orders 
WHERE salesman_id IN (SELECT * FROM salesman WHERE salesman_city='New York');
...
SELECT * FROM orders 
WHERE salesman_id IN (SELECT * FROM salesman WHERE city='New York');
...
SELECT * FROM orders WHERE salesman_id IN(SELECT * FROM salesman WHERE salesman_city='New York');
